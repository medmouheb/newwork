...
const CategorieTab = [
    {
        ...
        category: [
            {
                name: "product k0",
                list: [{name: "product 1", liink: "#"}, {name: "product 2", liink: "#"}, {
                    name: "product 3",
                    liink: "#"
                }, {name: "product 7", liink: "#"}, {name: "product 58", liink: "#"}, {
                    name: "product 8",
                    liink: "#"
                }, {name: "product 11", liink: "#"}]
            },
            {
                name: "product j",
                list: [{name: "product 1", liink: "#"}, {name: "product 2", liink: "#"}, {
            ...
            },
            {
                ...
                list: [{name: "product 1", liink: "#"}, {name: "product 2", liink: "#"}, {
                    ...
                    name: "product 8",
                    liink: "#"
                }, {name: "product 11", liink: "#"}, {name: "product 7", liink: "#"}, {
                    name: "product 58",
                    liink: "#"
                }, {name: "product 8", liink: "#"}, {name: "product 11", liink: "#"}]
            },
            {
                name: "product ll",
                list: [{name: "product 1", liink: "#"}, {name: "product 2", liink: "#"}, {
