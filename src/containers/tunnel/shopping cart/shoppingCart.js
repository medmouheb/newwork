    ...
    render() {
        ...
        return (
            ...
            <div style={{ display: "flex", position: 'relative' }}>
                ...
                <i class="	fa fa-shopping-cart"  style={{fontSize:"80px"}}><Badge variant="light">{this.props.totalitems}</Badge></i><br />
                <i class="	fas fa-money-check-alt"  style={{fontSize:"80px"}}><Badge variant="light">{this.props.total}</Badge></i>
                </div>
            </div>
